...
yy: {},
symbols_: {"error":2,"Init":3,"E":4,"EOF":5,"MAS":6,"T":7,"MENOS":8,"POR":9,"F":10,"DIV":11,"(":12,")":13,"NUMBER":14,"ID":15,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"MAS",8:"MENOS",9:"POR",11:"DIV",12:"(",13:")",14:"NUMBER",15:"ID"},
...
case 2:
        ...
        this.$ = new Aritmetica($$[$0-2], $$[$0], tipoOperacion.MAS, _$[$0-2].first_line,_$[$0-2].first_column);
    
break;
case 3:

        this.$ = new Aritmetica($$[$0-2], $$[$0], tipoOperacion.MENOS, _$[$0-2].first_line,_$[$0-2].first_column);
...
case 5:
        ...
        this.$ = new Aritmetica($$[$0-2], $$[$0], tipoOperacion.POR, _$[$0-2].first_line,_$[$0-2].first_column);
    
break;
case 6:

        this.$ = new Aritmetica($$[$0-2], $$[$0], tipoOperacion.DIV, _$[$0-2].first_line,_$[$0-2].first_column);
...
case 9: case 10:
        ...
        this.$ = new Factor($$[$0], _$[$0].first_line, _$[$0].first_column);
...
case 5:return 11;
break;
case 6:return 'PARIZQ';
break;
case 7:return 'PARDER';
break;
case 8:return 15;
break;
case 9:return 5
...
rules: [/^(?:\s+)/i,/^(?:(([0-9]+)(\.([0-9]+))?))/i,/^(?:\+)/i,/^(?:-)/i,/^(?:\*)/i,/^(?:\/)/i,/^(?:\()/i,/^(?:\))/i,/^(?:([a-zA-Z_])[a-zA-Z0-9_ñÑ]*)/i,/^(?:$)/i],
